# Add the functions below at the end of the WindowsAutoPilotIntune.psm1 file
# 1. Open PowerShell
# 2. Type Remove-WindowsAutoPilotIntune
# 3. Type Add the below functions in the file
# 4. Type Import-WindowsAutoPilotIntune
# 5. Type Get-command -module WindowsAutoPilotIntune to list new functions
